            ...
            tarteaucitron.addScript(pathToServices, '', function () {
                ...
                if (tarteaucitron.orientation === 'middle') {
                    var customThemeMiddle = document.createElement('style'),
                        cssRuleMiddle = 'div#tarteaucitronAlertBig:before {font-size: 50px;}body #tarteaucitronRoot div#tarteaucitronAlertBig {width: 100%;min-width: 285px;height: auto;margin: auto;left: 50%;top: 75%;transform: translate(-50%, -50%);box-shadow: 0 0 9000px #000;border-radius: 0;padding: 10px 0;}span#tarteaucitronDisclaimerAlert {padding: 0 30px;}#tarteaucitronRoot span#tarteaucitronDisclaimerAlert {margin: 50px 0;display: block;text-align: center;font-size: 21px;}';
